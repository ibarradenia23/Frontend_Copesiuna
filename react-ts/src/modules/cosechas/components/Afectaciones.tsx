...
const Afectaciones = () => {
  ...
  return (
    <div className="min-h-128 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-2">
      ...
      <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-32 flex justify-between">
        <div className="">
          <h4 className="text-[1.2rem] font-bold text-gray-900 dark:text-white mt-4">
            Nombre de afectacion
          </h4>
          <span className="flex text-gray-700 dark:text-gray-400 items-center">
            <Receipt className="inline mr-1 h-4 w-4" /> Descripcion de la
            afectacion
          </span>
        </div>
