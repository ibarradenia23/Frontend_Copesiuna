...
import { useActualizarTiposParcela, useCrearTiposParcela } from "../hooks/useTiposParcelas";
          ...
          useEffect(() => {
            ...
            const onSubmit =async(data:TiposParcelaInterface) =>{
                if(isEditing && tipoParcela && tipoParcela.id){
                    editarTipoParcela({id:tipoParcela.id,...data})
                } else {
             ...
             useEffect(() => {
                ...
                if (isErrorEditar) {
                  setToast({
                    type: "error",
                    message:
                      "Error al editar el tipo de parcela: " + (errorEditar as Error).message,
                    visible: true,
                  });
                }
